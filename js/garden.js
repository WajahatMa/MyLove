...
Garden.options = {
    ...
    growSpeed: 1000 / 60,
    color: {
        // Shades of purple (Red + Blue)
        rmin: 128, // Set red to a medium value
        rmax: 255, // Allow a higher red value
        gmin: 0, // Keep green low for purples
        gmax: 64, // Slight green tint
        bmin: 128, // Higher blue value for purple
        bmax: 255, // Full range for vibrant purple
        opacity: 0.1
    },
    tanAngle: 60
};
